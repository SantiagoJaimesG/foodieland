                        ...
                        <div class="col-md-3">
                            <h1>Postres</h1>
                                <form action="insertar.php" method="POST">
                                    ...
                                    <input type="text" class="form-control mb-3" name="cod_postre" placeholder="cod postre">
                        ...
                        <div class="col-md-8">
                            <table class="table" >
                                ...
                                <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                <th><?php  echo $row['cod_postre']?></th>
                                                <th><?php  echo $row['nombre']?></th>
                                                <th><?php  echo "<img src=".$row['imagen']." style='width: 100px; height: 60px;'>"?></th>
                                                <th><?php  echo $row['descripcion']?></th>
                                                <th><?php  echo $row['precio']?></th>    
                                                <th><a href="actualizar.php?id=<?php echo $row['cod_postre'] ?>" class="btn btn-info">Editar</a></th>
                                                <th><a href="delete.php?id=<?php echo $row['cod_postre'] ?>" class="btn btn-danger">Eliminar</a></th>                                        
                                            </tr>
                                        <?php 
                                            }
                                        ?>
